...
var geradorSenha = /*#__PURE__*/function () {
  function geradorSenha(numCarac, parametro) {
    _classCallCheck(this, geradorSenha);

    this.numCarac = numCarac;
    this.parametros = parametro;
    this.parametrosVez = _toConsumableArray(parametro);
    this.senha;
  ...
  _createClass(geradorSenha, [{
    key: "vez",
    value: function vez(parametro) {
      var aindaTem = parametro.reduce(function (ac, valor, indice, array) {
        return ac ? ac : valor;
      });
      var indiceTem = parametro.reduce(function (ac, valor, indice, array) {
      ...
      if (aindaTem) {
        ...
        this.parametrosVez = _toConsumableArray(this.parametros);

        for (var text in this.parametrosVez) {
    ...
    key: "geraSenha",
    value: function geraSenha(numCarac) {
      var senha = ' ';

      for (var carac = 1; carac <= numCarac; carac++) {
        var digito = this.geraDigito();
        senha = senha + digito;
      }
    ...
    key: "geraDigito",
    value: function geraDigito() {
      var vez = this.vez(this.parametrosVez);
    ...
    value: function geraMaiuscula() {
      ...
      var caracAleatorio = Math.floor(Math.random() * (letrasMaiusculas.length - 1) + 1);
    ...
    value: function geraMinuscula() {
      ...
      var caracAleatorio = Math.floor(Math.random() * (letrasMinusculas.length - 1) + 1);
      return letrasMinusculas[caracAleatorio];
    }
  }, {
    key: "geraNumber",
    value: function geraNumber() {
      return Math.floor(Math.random() * (9 - 1) + 1);
    }
  }, {
    key: "geraSimbolos",
    value: function geraSimbolos() {
      var caracteresEspeciais = '!@#$%¨&*()_+=-;:^~}]º{[ª`^.,|';
      var caracAleatorio = Math.floor(Math.random() * (caracteresEspeciais.length - 1) + 1);
...
(function () {
  ...
  document.addEventListener('click', function (e) {
    ...
    if (el.classList.contains('gerar-senha')) {
      var numCarac = document.querySelector('.num-carac').value;
      ...
      var gera = new _modules_geradorSenha__WEBPACK_IMPORTED_MODULE_0__["default"](numCarac, arrayParameters);
