...
var Cpf = /*#__PURE__*/function () {
  function Cpf(cpf) {
    ...
    this.valida(this.cpf);
  }

  _createClass(Cpf, [{
    key: "valida",
    value: function valida(cpf) {
      var cpfLimpo = cpf.replace(/\D+/g, '');
      var cpfParcial = cpfLimpo.slice(0, -2);

      var criaDigito = function criaDigito(cpfParcial) {
      ...
      var digito1 = criaDigito(cpfParcial);
      var digito2 = criaDigito(cpfParcial + digito1);
      var cpfGerado = cpfParcial + digito1 + digito2;
      console.log(cpfGerado, cpfLimpo);
...
var cpf = new _Cpf__WEBPACK_IMPORTED_MODULE_0__["default"]('487456456-12');
console.log(cpf);
